    ...
    @auth
        <div class="w-full max-w-lg h-fit flex flex-col space-y-2">
            <div class="w-full h-fit">
                <h1 class="h1 text-gray-100 text-left">Add box</h1>
            </div>
            <form action="{{ route('boxes.store') }}" method="post" class="w-full h-fit max-w-lg p-4 flex flex-col space-y-4 justify-center items-center bg-gray-100 rounded-lg">
                @csrf
                @method('POST')
